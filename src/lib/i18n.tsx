...
export const dict = {
  ...
  edit_employee: { en: "Edit Employee", hi: "कर्मचारी संपादित करें" },
  delete_employee: { en: "Delete Employee", hi: "कर्मचारी हटाएं" },
  reset_pin: { en: "Reset PIN", hi: "PIN रीसेट करें" },
  reregister_face: { en: "Re-register Face", hi: "चेहरा फिर से पंजीकृत करें" },
  employee_id: { en: "Employee ID", hi: "कर्मचारी ID" },
  joining_date: { en: "Joining Date", hi: "कार्यग्रहण तिथि" },
  face_registration: { en: "Face Registration", hi: "चेहरा पंजीकरण" },
  face_registered: { en: "Registered", hi: "पंजीकृत" },
  face_not_registered: { en: "Not Registered", hi: "पंजीकृत नहीं" },
  employee_updated: { en: "Employee updated", hi: "कर्मचारी अपडेट हो गया" },
  employee_deleted: { en: "Employee deleted", hi: "कर्मचारी हटा दिया" },
  face_updated: { en: "Face registration updated", hi: "चेहरा पंजीकरण अपडेट" },
  confirm_delete_employee: {
    en: "This will permanently delete the employee and ALL related data (attendance, tasks, reports, leaves, notifications, face registration). This cannot be undone.",
    hi: "यह कर्मचारी और सभी संबंधित डेटा (हाज़िरी, कार्य, रिपोर्ट, छुट्टियाँ, सूचनाएँ, चेहरा पंजीकरण) को स्थायी रूप से हटा देगा। इसे पूर्ववत नहीं किया जा सकता।",
  },
  delete: { en: "Delete", hi: "हटाएं" },
  view_details: { en: "View Details", hi: "विवरण देखें" },
  employee_details: { en: "Employee Details", hi: "कर्मचारी विवरण" },
  summary: { en: "Summary", hi: "सार" },
  leave: { en: "Leave", hi: "छुट्टी" },
  present_days: { en: "Present days", hi: "उपस्थित दिन" },
  total_tasks: { en: "Total tasks", hi: "कुल कार्य" },
  total_reports: { en: "Total reports", hi: "कुल रिपोर्ट" },
  leave_days_used: { en: "Leave days used", hi: "छुट्टी के दिन" },
  actions: { en: "Actions", hi: "कार्य" },
  editable_by_admin: { en: "Only admin can change", hi: "केवल प्रशासक बदल सकता है" },
  ...
  notif_date_all: { en: "Any date", hi: "कोई भी तारीख़" },
  notif_date_today: { en: "Today", hi: "आज" },
  notif_date_7d: { en: "Last 7 days", hi: "पिछले 7 दिन" },
  notif_date_30d: { en: "Last 30 days", hi: "पिछले 30 दिन" },
  notif_date_custom: { en: "Custom range", hi: "कस्टम रेंज" },
  clear_all: { en: "Clear all", hi: "सब साफ़ करें" },
  ...
  tab_active: { en: "Active", hi: "सक्रिय" },
  tab_archive: { en: "Archive", hi: "संग्रह" },
  status_assigned: { en: "Assigned", hi: "सौंपा गया" },
  status_awaiting_verification: { en: "Awaiting Verification", hi: "सत्यापन बाकी" },
  status_archived: { en: "Archived", hi: "संग्रहित" },
  completed_date: { en: "Completed Date", hi: "पूर्ण तिथि" },
  archived_date: { en: "Archived Date", hi: "संग्रह तिथि" },
  archived_tasks: { en: "Archived Tasks", hi: "संग्रहित कार्य" },
  last_30_days: { en: "Last 30 Days", hi: "पिछले 30 दिन" },
  last_60_days: { en: "Last 60 Days", hi: "पिछले 60 दिन" },
  custom_range: { en: "Custom Range", hi: "कस्टम रेंज" },
  showing: { en: "Showing", hi: "दिखा रहा" },
  of: { en: "of", hi: "में से" },
  previous: { en: "Previous", hi: "पिछला" },
  next: { en: "Next", hi: "अगला" },
  read_only: { en: "Read only", hi: "केवल पढ़ने के लिए" },
  employee_marked_complete: { en: "Employee marked this task complete", hi: "कर्मचारी ने कार्य पूर्ण चिह्नित किया" },
  verify_task_hint: { en: "Approve to archive the task, or reject to send it back.", hi: "स्वीकार करें ताकि कार्य संग्रहित हो, या अस्वीकार करें।" },
  approve_archive: { en: "Approve & Archive", hi: "स्वीकार करें और संग्रह करें" },
  reject_return: { en: "Reject & Return", hi: "अस्वीकार करें" },
  task_archived: { en: "Task archived", hi: "कार्य संग्रहित" },
  task_returned: { en: "Task returned to In Progress", hi: "कार्य वापस भेजा गया" },
  submit_for_verification: { en: "Submit for Verification", hi: "सत्यापन के लिए भेजें" },
  submitted_for_verification: { en: "Sent for verification", hi: "सत्यापन के लिए भेजा गया" },
  ...
  dept_prefix: { en: "Dept", hi: "परियोजना" },
  ...
  rep_department: { en: "Project", hi: "परियोजना" },
  ...
  rg_all_departments: { en: "All Projects", hi: "सभी परियोजना" },
  ...
  // vehicle meter log
  vehicle_log: { en: "Vehicle Log", hi: "वाहन लॉग" },
  vehicle_logs: { en: "Vehicle Meter Logs", hi: "वाहन मीटर लॉग" },
  vm_vehicle: { en: "Vehicle", hi: "वाहन" },
  vm_vehicle_ph: { en: "e.g. RJ-14-AB-1234", hi: "जैसे RJ-14-AB-1234" },
  vm_date: { en: "Date", hi: "तारीख" },
  vm_start_km: { en: "Starting KM", hi: "शुरुआती KM" },
  vm_end_km: { en: "Ending KM", hi: "अंतिम KM" },
  vm_total_km: { en: "Total KM", hi: "कुल KM" },
  vm_meter_photo: { en: "Odometer Photo", hi: "मीटर फ़ोटो" },
  vm_photo_hint: { en: "Take a close-up of the meter only, with the reading clearly visible.", hi: "सिर्फ़ मीटर की नज़दीकी फ़ोटो लें, रीडिंग साफ़ दिखे।" },
  vm_capture_meter: { en: "Capture Meter Photo", hi: "मीटर फ़ोटो लें" },
  vm_checking: { en: "Checking photo...", hi: "फ़ोटो जाँच रहे हैं..." },
  vm_my_entries: { en: "My Entries", hi: "मेरी एंट्री" },
  vm_no_entries: { en: "No entries yet", hi: "अभी कोई एंट्री नहीं" },
  vm_entries: { en: "Entries", hi: "एंट्री" },
  vm_status_verified: { en: "Verified", hi: "सत्यापित" },
  vm_status_flagged: { en: "Flagged", hi: "चिन्हित" },
  vm_status_reviewed: { en: "Reviewed", hi: "समीक्षित" },
  vm_validation: { en: "Validation", hi: "जाँच" },
  vm_review: { en: "Review", hi: "समीक्षा" },
  vm_review_notes: { en: "Review notes", hi: "समीक्षा टिप्पणी" },
  vm_mark_reviewed: { en: "Mark Reviewed", hi: "समीक्षित करें" },
  vm_keep_flagged: { en: "Keep Flagged", hi: "चिन्हित रखें" },
  vm_review_saved: { en: "Review saved", hi: "समीक्षा सहेजी" },
  vm_photo_reading: { en: "Reading detected in photo", hi: "फ़ोटो से पढ़ी गई रीडिंग" },
  vm_need_vehicle: { en: "Enter the vehicle", hi: "वाहन लिखें" },
  vm_need_km: { en: "Enter starting and ending KM", hi: "शुरुआती और अंतिम KM लिखें" },
  vm_end_less: { en: "Ending KM cannot be less than Starting KM", hi: "अंतिम KM शुरुआती KM से कम नहीं हो सकता" },
  vm_need_photo: { en: "Odometer photo is required", hi: "मीटर फ़ोटो ज़रूरी है" },
  vm_photo_failed: { en: "Could not process the photo", hi: "फ़ोटो प्रोसेस नहीं हो सकी" },
  vm_retake_photo: { en: "Please retake the meter photo", hi: "कृपया मीटर फ़ोटो दोबारा लें" },
  vm_saved: { en: "Reading saved and verified", hi: "रीडिंग सहेजी और सत्यापित" },
  vm_saved_flagged: { en: "Saved, but flagged for admin review", hi: "सहेजा गया, पर एडमिन समीक्षा के लिए चिन्हित" },
  vm_from: { en: "From", hi: "से" },
  vm_to: { en: "To", hi: "तक" },
  vm_export_excel: { en: "Monthly Excel", hi: "मासिक एक्सेल" },
  vm_nothing_export: { en: "Nothing to export", hi: "एक्सपोर्ट के लिए कुछ नहीं" },
  vm_export_pdf: { en: "Monthly PDF", hi: "मासिक पीडीएफ" },
  vm_start_photo: { en: "Starting KM Photo", hi: "शुरुआती KM फ़ोटो" },
  vm_end_photo: { en: "Ending KM Photo", hi: "अंतिम KM फ़ोटो" },
  vm_need_both_photos: { en: "Both meter photos are required", hi: "दोनों मीटर फ़ोटो ज़रूरी हैं" },
  vm_photo_too_big: { en: "Photo is too large. Take a closer, simpler shot of the meter.", hi: "फ़ोटो बहुत बड़ी है। मीटर की नज़दीकी, सरल फ़ोटो लें।" },
  vm_details: { en: "Vehicle Log Details", hi: "वाहन लॉग विवरण" },
  vm_photos: { en: "Meter Photos", hi: "मीटर फ़ोटो" },
  vm_photos_expired: { en: "Photos deleted (kept 3 days only)", hi: "फ़ोटो हटा दी गईं (सिर्फ़ 3 दिन रखी जाती हैं)" },
  vm_start_reading: { en: "Start photo reading", hi: "शुरुआती फ़ोटो रीडिंग" },
  vm_end_reading: { en: "End photo reading", hi: "अंतिम फ़ोटो रीडिंग" },
  vm_audit: { en: "Audit", hi: "ऑडिट" },
  vm_flag_audit: { en: "Flag for Audit", hi: "ऑडिट के लिए चिन्हित करें" },
  vm_clear_audit: { en: "Clear Audit Flag", hi: "ऑडिट चिन्ह हटाएँ" },
  vm_audit_reason: { en: "Audit reason", hi: "ऑडिट कारण" },
  vm_audit_need_reason: { en: "Enter an audit reason", hi: "ऑडिट कारण लिखें" },
  vm_audit_flagged: { en: "Flagged for Audit", hi: "ऑडिट के लिए चिन्हित" },
  vm_audit_saved: { en: "Audit flag updated", hi: "ऑडिट चिन्ह अपडेट हुआ" },
  vm_audit_history: { en: "Audit history", hi: "ऑडिट इतिहास" },
} satisfies Dict;
